        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="admin?submit=PlacedState"><i class="fas fa-receipt mr-2"></i>Placed Orders</a>
                    </li>
                    <li>
                        <a href="admin?submit=PrepState"><i class="fas fa-box-open mr-2"></i>Orders In Preperation</a>
                    </li>
                    <li>
                        <a href="admin?submit=OutState"><i class="fas fa-user-friends mr-2"></i>Orders Out For Delivery</a>
                    </li>
