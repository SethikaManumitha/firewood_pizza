...
<body>
    ...
    <div class="banner">
        <img src="assets/banner2.jpg" alt="Firewood Pizza Banner">
    ...
    <div class="order-section">
        ...
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Delivery postcode">
            <div class="input-group-append">
                <button class="btn view-deals-btn" type="button">View Deals</button>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
            <button class="btn btn-danger btn-promo">View All Promotions</button>
            </div>
        </div>
     </div>
